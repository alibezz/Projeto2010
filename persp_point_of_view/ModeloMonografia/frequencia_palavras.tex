...
A classificação de um documento de acordo com sua perspectiva é o problema mais discutido nos artigos revisados para este projeto. Partindo da hipótese de que documentos escritos sob perspectivas diferentes costumam enfatizar termos distintos \cite{teubert}, classificadores como Naïve Bayes e SVMs podem ser empregados para, considerando apenas as diferentes contagens de palavras em documentos, identificar suas perspectivas. De fato, grande parte dos artigos estudados para esta monografia procedem dessa forma, ainda que combinem os resultados dos classificadores a outros métodos ou utilizem, associadamente, outras características dos documentos. Pela relevância que a contagem de palavras tem na Mineração de Perspectiva, portanto, esse capítulo é totalmente dedicado à revisão e discussão de seu uso na identificação automática da perspectiva de documentos.
%ou mesmo utilizar palavras com conotações diferentes para um mesmo propósito,

Embora seja sempre possível associar contagens de palavras a aspectos temáticos, sintáticos e semânticos dos documentos, conduzindo a representações linguísticas mais complexas de cada um deles, este não é o enfoque dado pelos artigos revisados neste capítulo. Como será discutido nas próximas seções, a simples consideração das palavras utilizadas nos documentos costuma resultar em classificações de boa qualidade. Essa qualidade, entretanto, varia de acordo com o quanto essas contagens mudam de uma perspectiva para outra. Quanto mais elas mudam, mais fácil se torna, para um classificador, aprender a perspectiva dos documentos.  %a diferença nas contagens de palavras  

Variações no uso de contagem de palavras foram encontradas em parte dos trabalhos analisados: alguns deles utilizam valores \emph{booleanos} para indicar a presença (1) ou ausência (0) de palavras nos documentos e outros utilizam a contagem de \textbf{sequências de palavras}, em vez de considerarem cada uma delas separadamente\footnote{Essas outras características aparecem ora combinadas entre si, ora associadas à contagem de palavras padrão, ora separadamente.}. \textbf{BOTAR REFERENCIAS!!!} Esses trabalhos também são discutidos neste capítulo, pois a hipótese linguística assumida por eles, em suas metodologias, é a mesma: textos escritos sob perspectivas diferentes empregam palavras de forma distinta. \textbf{falar da figura}
