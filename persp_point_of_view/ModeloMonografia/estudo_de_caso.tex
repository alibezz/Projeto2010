...
Esses experimentos indicam que o Naïve Bayes aprendeu a generalizar bem os pontos de vista contidos nos documentos, o que sugere que seu uso, estendido à classificação de outros documentos dentro da mesma temática, pode ser adequado. Apenas em caráter de ilustração, segue um trecho de um dos documentos  que o Naïve Bayes classificou corretamente:
...
Também em caráter de ilustração, segue um trecho de um dos documentos que o Naïve Bayes classificou incorretamente:
