...
Essas escolhas se mostraram adequadas para o problema: a taxa de acerto obtida na classificação foi de 89.43\%. Assim como em outros artigos revisados no Capítulo \ref{chap3} \cite{lin-et-al2006} \cite{aaai-politics} \cite{klebanov}, esse valor foi obtido via validação cruzada de dez dobras. A precisão, rechamada e métrica F1 associadas a cada classe (ponto de vista) constam na Tabela 4.2. %tabela mais precisa %precisao 0 0,915979712 precisao 1 0,877579312 % rechamada 0 0,870754717 1 0,917924528  %f1 0 0,891837888 1 0,896484354
...
\textbf{Pró-oposição} & dilma, lula, presidente, brasil, rousseff, pt, gente, candidata, mundo, petista \\ \hline
\end{tabular}
\label{tab:palavras}
