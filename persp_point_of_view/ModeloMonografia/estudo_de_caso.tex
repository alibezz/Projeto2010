...
\begin{figure}[h]
  ...
  \includegraphics[width=12.5cm, height=6.5cm]{15palavras-situacao.jpg}\\
...
\begin{figure}[h]
  \centering % este comando é usado para centralizar a Figura
  \includegraphics[width=11.5cm, height=6.8cm]{15palavras-oposicao.jpg}\\
